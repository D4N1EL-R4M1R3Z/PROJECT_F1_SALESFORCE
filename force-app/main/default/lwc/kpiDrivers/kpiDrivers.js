...
import driverCircuits from '@salesforce/apex/DriverKpiService.driverCircuits';

export default class KpiDrivers extends LightningElement {
  @api backgroundColor = '#1b66e4';
  @api textColor = '#ffffff';
  @api targetTabValue = 'driver'; // para que el contenedor cambie al tab "Circuitos"
  ...
  async load() {
    ...
    try {
      this.total = await driverCircuits(); // 👈 consulta SOLO en Apex
    } catch (e) {
